class ReciparnCard extends HTMLElement {
  ...
  setConfig(config) {
    if (!config.function_url) throw new Error("arnecipe: function_url is required");
    if (!config.ha_secret) throw new Error("arnecipe: ha_secret is required");
    this._config = config;
    this._render();
    this._fetchRecipes();
  }
    ...
    this.shadowRoot.innerHTML = `
      <style>
        ...
        * { box-sizing: border-box; }
        ...
        .header {
          background: linear-gradient(135deg, #7a6352 0%, #9e8068 100%);
        ...
        input[type="text"]:focus { border-color: #8f7055; }
        ...
        .recipe-item:hover { background: rgba(143,112,85,0.06); }
        .recipe-item:active { background: rgba(143,112,85,0.12); }
        .recipe-dot {
          width: 8px;
          height: 8px;
          border-radius: 50%;
    ...
    this.shadowRoot.innerHTML = `
      <style>
        ...
        * { box-sizing: border-box; }
        ...
        .select-label { font-size: 12px; color: #8f7055; font-weight: 500; }
        .select-all-btn {
          background: none;
        ...
        .select-all-btn:hover { background: #8f7055; color: #fff; }
        ...
        .ingredient:hover { background: rgba(143,112,85,0.04); }
        ...
        .add-btn {
          ...
          box-shadow: 0 2px 6px rgba(143,112,85,0.25);
        }
